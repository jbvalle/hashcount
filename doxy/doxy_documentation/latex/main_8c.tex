...
\DoxyCodeLine{00068 }
\DoxyCodeLine{00069     \mbox{\hyperlink{fill__buckets_8h_ad7879271ac1cf2fd1a4fd3159d65b627}{fill\_buckets}}(buckets, hash\_limit, input\_stream);}
\DoxyCodeLine{00070     }
\DoxyCodeLine{00071     \mbox{\hyperlink{display__list_8h_ad0de26c7c2dc54dba3dbec2d7623e6a7}{display\_list}}(buckets, output\_stream, 40);}
\DoxyCodeLine{00072 }
...
\DoxyCodeLine{00099         \mbox{\hyperlink{choose__buckets_8h_a8ae7c98d661bdc4d004450b9548a60c3}{choose\_buckets}}(buckets, requested\_index, chosen\_flag);}
...
\DoxyCodeLine{00102         \mbox{\hyperlink{censor__buckets_8h_ac3c63497a5e45ed0a4dab4c05d9ac171}{censor\_buckets}}(buckets, input\_stream, output\_stream, requested\_index);}
\DoxyCodeLine{00103 }
\DoxyCodeLine{00104         printf(\mbox{\hyperlink{main_8c_a1169cd1b397420b29bd3b0153f047818}{COLOR1}});printf(\textcolor{stringliteral}{"\(\backslash\)n\(\backslash\)nTextfile censored\_buckets.txt was created\(\backslash\)n"});printf(\mbox{\hyperlink{main_8c_ab702106cf3b3e96750b6845ded4e0299}{RESET}});}
...
\DoxyCodeLine{00124         \mbox{\hyperlink{choose__buckets_8h_a8ae7c98d661bdc4d004450b9548a60c3}{choose\_buckets}}(buckets, requested\_index, chosen\_flag);}
\DoxyCodeLine{00125         \textcolor{comment}{//Censor all word matching the buckets}}
\DoxyCodeLine{00126         \mbox{\hyperlink{censor__buckets_8h_ac3c63497a5e45ed0a4dab4c05d9ac171}{censor\_buckets}}(buckets, input\_stream, output\_stream, requested\_index);}
\DoxyCodeLine{00127 }
...
\DoxyCodeLine{00135         }
\DoxyCodeLine{00136         printf(\mbox{\hyperlink{main_8c_a1169cd1b397420b29bd3b0153f047818}{COLOR1}});printf(\textcolor{stringliteral}{"\(\backslash\)n\(\backslash\)nTextfile censored\_all\_except\_buckets.txt was created\(\backslash\)n"});printf(\mbox{\hyperlink{main_8c_ab702106cf3b3e96750b6845ded4e0299}{RESET}});}
...
\DoxyCodeLine{00139         \mbox{\hyperlink{censor__except__buckets_8h_ae6b559bb68ba469e9a375b77de8bf2c2}{censor\_except\_buckets}}(input\_stream, input\_stream\_censored, output\_stream);}
\DoxyCodeLine{00140 }
...
\DoxyCodeLine{00148     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < hash\_limit; i++)\mbox{\hyperlink{free__buckets_8h_a49fec80669e0bd67bbdc830bd45572e6}{free\_buckets}}(buckets[i]);}
\DoxyCodeLine{00149 }
