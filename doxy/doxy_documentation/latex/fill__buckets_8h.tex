\hypertarget{fill__buckets_8h}{}\doxysection{/home/jv/\+Coding/hashcount/inc/fill\+\_\+buckets.h File Reference}
\label{fill__buckets_8h}\index{/home/jv/Coding/hashcount/inc/fill\_buckets.h@{/home/jv/Coding/hashcount/inc/fill\_buckets.h}}
This graph shows which files directly or indirectly include this file\+:
% FIG 0
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
uint64\+\_\+t \mbox{\hyperlink{fill__buckets_8h_a81d78745bfb621471ef9dac9badb6db9}{pow\+\_\+t}} (int base, int exp)
...
int \mbox{\hyperlink{fill__buckets_8h_aa6707e4d0f37a801750800a3571741fc}{hash\+\_\+index}} (char $\ast$word, int hash\+\_\+limit)
\item 
void \mbox{\hyperlink{fill__buckets_8h_ad8202785f43186178e979f230ffa5075}{add\+\_\+node}} (\mbox{\hyperlink{node__t_8h_a7c02633e18d6aa5f58539b75f08753d9}{node\+\_\+t}} $\ast$$\ast$head, char $\ast$new\+\_\+key)
\item 
void \mbox{\hyperlink{fill__buckets_8h_ad7879271ac1cf2fd1a4fd3159d65b627}{fill\+\_\+buckets}} (\mbox{\hyperlink{node__t_8h_a7c02633e18d6aa5f58539b75f08753d9}{node\+\_\+t}} $\ast$$\ast$buckets, int hash\+\_\+limit, F\+I\+LE $\ast$input\+\_\+stream)
...
\mbox{\Hypertarget{fill__buckets_8h_ad8202785f43186178e979f230ffa5075}\label{fill__buckets_8h_ad8202785f43186178e979f230ffa5075}} 
\index{fill\_buckets.h@{fill\_buckets.h}!add\_node@{add\_node}}
\index{add\_node@{add\_node}!fill\_buckets.h@{fill\_buckets.h}}
\doxysubsubsection{\texorpdfstring{add\_node()}{add\_node()}}
{\footnotesize\ttfamily void add\+\_\+node (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{node__t_8h_a7c02633e18d6aa5f58539b75f08753d9}{node\+\_\+t}} $\ast$$\ast$}]{head,  }\item[{char $\ast$}]{new\+\_\+key }\end{DoxyParamCaption})}

Adds new node to list using \mbox{\hyperlink{stack_8h_a566f0c4642ac167626a631f693169b11}{stack()}}, \mbox{\hyperlink{insert_8h_a1f22eccdb6399bb02fcac2ab4102bcdd}{insert()}} and \mbox{\hyperlink{append_8h_a53de05066e101242b94e4f458b5ae35b}{append()}} function Add new node in alphabetical order depending in string members of elements 
...
\DoxyCodeLine{00106     \textcolor{keywordflow}{if}(strcmp(ptr-\/>\mbox{\hyperlink{structnode_a4fac939f5236506c96b518c8bde027e6}{word}}, new\_key) > 0)\{}
\DoxyCodeLine{00107 }
\DoxyCodeLine{00108         \mbox{\hyperlink{stack_8h_a566f0c4642ac167626a631f693169b11}{stack}}(head, new\_key);}
\DoxyCodeLine{00109         \textcolor{keywordflow}{return};}
\DoxyCodeLine{00110     \}}
\DoxyCodeLine{00111 }
\DoxyCodeLine{00113     ptr = *head;}
\DoxyCodeLine{00114 }
\DoxyCodeLine{00115     \textcolor{keywordflow}{for}(; (ptr-\/>\mbox{\hyperlink{structnode_aa3e8aa83f864292b5a01210f4453fcc0}{next}} != NULL)\&\&(strcmp(ptr-\/>\mbox{\hyperlink{structnode_aa3e8aa83f864292b5a01210f4453fcc0}{next}}-\/>\mbox{\hyperlink{structnode_a4fac939f5236506c96b518c8bde027e6}{word}}, new\_key) > 0); ptr = ptr-\/>\mbox{\hyperlink{structnode_aa3e8aa83f864292b5a01210f4453fcc0}{next}});}
\DoxyCodeLine{00116 }
\DoxyCodeLine{00117     \mbox{\hyperlink{insert_8h_a1f22eccdb6399bb02fcac2ab4102bcdd}{insert}}(head, ptr-\/>\mbox{\hyperlink{structnode_a4fac939f5236506c96b518c8bde027e6}{word}}, new\_key);}
\DoxyCodeLine{00118 }
\DoxyCodeLine{00120     \textcolor{keywordflow}{if}(ptr == NULL)\mbox{\hyperlink{append_8h_a53de05066e101242b94e4f458b5ae35b}{append}}(head, new\_key);}
\DoxyCodeLine{00121 }
\DoxyCodeLine{00122 \}}

\end{DoxyCode}
\mbox{\Hypertarget{fill__buckets_8h_ad7879271ac1cf2fd1a4fd3159d65b627}\label{fill__buckets_8h_ad7879271ac1cf2fd1a4fd3159d65b627}} 
\index{fill\_buckets.h@{fill\_buckets.h}!fill\_buckets@{fill\_buckets}}
\index{fill\_buckets@{fill\_buckets}!fill\_buckets.h@{fill\_buckets.h}}
\doxysubsubsection{\texorpdfstring{fill\_buckets()}{fill\_buckets()}}
{\footnotesize\ttfamily void fill\+\_\+buckets (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{node__t_8h_a7c02633e18d6aa5f58539b75f08753d9}{node\+\_\+t}} $\ast$$\ast$}]{buckets,  }\item[{int}]{hash\+\_\+limit,  }\item[{F\+I\+LE $\ast$}]{input\+\_\+stream }\end{DoxyParamCaption})}
...
\end{DoxyCode}
\mbox{\Hypertarget{fill__buckets_8h_aa6707e4d0f37a801750800a3571741fc}\label{fill__buckets_8h_aa6707e4d0f37a801750800a3571741fc}} 
\index{fill\_buckets.h@{fill\_buckets.h}!hash\_index@{hash\_index}}
\index{hash\_index@{hash\_index}!fill\_buckets.h@{fill\_buckets.h}}
...
\end{DoxyCode}
\mbox{\Hypertarget{fill__buckets_8h_a81d78745bfb621471ef9dac9badb6db9}\label{fill__buckets_8h_a81d78745bfb621471ef9dac9badb6db9}} 
\index{fill\_buckets.h@{fill\_buckets.h}!pow\_t@{pow\_t}}
\index{pow\_t@{pow\_t}!fill\_buckets.h@{fill\_buckets.h}}
